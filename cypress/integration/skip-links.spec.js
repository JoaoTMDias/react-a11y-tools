 ...
 * (c) 2021 joaodias.me
 */
const ROVER_STORY_URL = "/iframe.html?id=navigation-skip-links--skip-links&viewMode=story";

describe("Skip Links", () => {
	beforeEach(() => {
		cy.visit(ROVER_STORY_URL);
		cy.findByRole("button", { name: "Skip to main content" }).as("SkipMainContent");
		cy.findByRole("button", { name: "Go to navigation menu" }).as("SkipNavigationMenu");
