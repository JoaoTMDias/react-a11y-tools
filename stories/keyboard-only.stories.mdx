...
import images from "../test/components/keyboard-only/mocks/images";
import { KeyboardOnly } from "../src/components/keyboard-only/index";

<Meta
	title="Testing/Keyboard Only"
	component={KeyboardOnly}
