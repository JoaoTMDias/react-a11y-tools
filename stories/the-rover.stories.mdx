...
export const Sidenav = styled.nav`
	...
	.sidenav__link:focus {
		...
		box-shadow: 0 0 0 3px #35cecc, 20px 20px 60px hsl(188deg 47% 77% / 24%), -20px -20px 60px hsl(180deg 100% 90% / 15%);
	}
	.sidenav__link:focus {
		outline: none;
		background: linear-gradient(145deg, #c8ffff, #a8d7dd);
		box-shadow: 0 0 0 3px #35cecc, 0 0 0 3px #35cecc, 20px 20px 60px hsl(188deg 47% 77% / 24%), -20px -20px 60px hsl(180deg
						100% 90% / 15%);
	}
